...
export default function Login() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Account created successfully! Welcome to your new account!",
      });
      ...
      <Card className="w-full max-w-md shadow-strong animate-scale-in">
        <CardHeader className="text-center">
          <Link href="/" className="flex items-center justify-center mb-4">
            <span className="text-2xl font-bold text-gradient">SaaS Boilerplate</span>
          </Link>
          ...
          <CardDescription>
            {activeTab === "login" 
              ...
              : "Start with 1 free item, upgrade to Pro for unlimited access"
            }
          </CardDescription>
        </CardHeader>
        <CardContent>
